...
You can test APIs with some fake devices downloading and unpacking [this zip file] (https://github.com/ismb/it.ismb.pert.osgi.dal.web-apis/releases/download/2.0/dal-web-apis-bin.zip).
